...
function isFragment(child) {
  return child && isValidElement(child) && child.type === React21.Fragment;
}
function replaceElement(element, replacement, props) {
  if (!isValidElement(element)) {
    return replacement;
  }
  return React21.cloneElement(element, typeof props === "function" ? props(element.props || {}) : props);
}
...
var PurePanel = (props) => {
  ...
  }), React22.createElement(Popup, Object.assign({}, props, {
    className: hashId,
    prefixCls,
...
var Tooltip3 = React23.forwardRef((props, ref) => {
  var _a, _b;
  const {
    prefixCls: customizePrefixCls,
    openClassName,
  ...
  const tooltipPlacements = React23.useMemo(() => {
    var _a2, _b2;
  ...
  const memoOverlay = React23.useMemo(() => {
    if (title === 0) {
      return title;
    }
    return overlay || title || "";
  }, [overlay, title]);
  const memoOverlayWrapper = React23.createElement(NoCompactStyle, null, typeof memoOverlay === "function" ? memoOverlay() : memoOverlay);
  const {
    getPopupContainer,
    placement = "top",
    mouseEnterDelay = 0.1,
  ...
  const child = isValidElement(children) && !isFragment(children) ? children : React23.createElement("span", null, children);
  ...
  const content = React23.createElement(es_default5, Object.assign({}, otherProps, {
    zIndex,
    ...
    overlayInnerStyle: formattedOverlayInnerStyle,
    arrowContent: React23.createElement("span", {
  ...
  return wrapCSSVar(React23.createElement(zindexContext_default.Provider, {
    value: contextZIndex
  }, content));
});
if (true) {
...
var Editable = (props) => {
  const {
    ...
    onEnd,
    component,
    enterIcon = React24.createElement(EnterOutlined_default, null)
  } = props;
  const ref = React24.useRef(null);
  const inComposition = React24.useRef(false);
  const lastKeyCode = React24.useRef();
  const [current, setCurrent] = React24.useState(value);
  React24.useEffect(() => {
    setCurrent(value);
  }, [value]);
  React24.useEffect(() => {
  ...
  return wrapCSSVar(React24.createElement("div", {
    className: textAreaClassName,
    style
  }, React24.createElement(TextArea_default, {
    ref,
    maxLength,
    value: current,
    onChange,
...
var Typography = React25.forwardRef((props, ref) => {
  const {
    prefixCls: customizePrefixCls,
  ...
  return wrapCSSVar(
    ...
    React25.createElement(Component, Object.assign({
...
var useUpdatedEffect = (callback, conditions) => {
  const mountRef = React27.useRef(false);
  React27.useEffect(() => {
    if (mountRef.current) {
      callback();
    } else {
...
var Ellipsis = (_ref) => {
  ...
  const [[startLen, midLen, endLen], setCutLength] = React28.useState([0, 0, 0]);
  const [lastLen, setLastLen] = React28.useState(0);
  const [walkingState, setWalkingState] = React28.useState(NONE);
  const [singleRowHeight, setSingleRowHeight] = React28.useState(0);
  const singleRowRef = React28.useRef(null);
  const midRowRef = React28.useRef(null);
  const nodeList = React28.useMemo(() => toArray(text), [text]);
  const totalLen = React28.useMemo(() => getNodesLen(nodeList), [nodeList]);
  const mergedChildren = React28.useMemo(() => {
  ...
  const renderMeasure = (content, ref, style) => React28.createElement("span", {
    "aria-hidden": true,
    ref,
    style: Object.assign({
      position: "fixed",
  ...
  return React28.createElement(React28.Fragment, null, mergedChildren, enabledMeasure && walkingState !== DONE_WITH_ELLIPSIS && walkingState !== DONE_WITHOUT_ELLIPSIS && React28.createElement(React28.Fragment, null, renderMeasure("lg", singleRowRef, {
    wordBreak: "keep-all",
    whiteSpace: "nowrap"
...
var Base = React30.forwardRef((props, ref) => {
  ...
  const copyIdRef = React30.useRef(null);
  const copyOptions = {};
  ...
  const cssEllipsis = React30.useMemo(() => {
  ...
  const [ellipsisFontSize, setEllipsisFontSize] = React30.useState(0);
  ...
  } else if (React30.isValidElement(ellipsisConfig.tooltip)) {
    tooltipProps = {
  ...
  const renderExpand = () => {
    ...
    return React30.createElement("a", {
      key: "expand",
  ...
  const renderEdit = () => {
    ...
    }, React30.createElement(transButton_default, {
      ref: editIconRef,
  ...
  const renderCopy = () => {
    ...
    return React30.createElement(tooltip_default, {
      key: "copy",
      title: copyTitle
    }, React30.createElement(transButton_default, {
      ...
      onClick: onCopyClick,
      "aria-label": ariaLabel
    }, copied ? getNode(iconNodes[1], React30.createElement(CheckOutlined_default, null), true) : getNode(iconNodes[0], React30.createElement(CopyOutlined_default, null), true)));
  };
  const renderOperations = (renderExpanded) => [renderExpanded && renderExpand(), renderEdit(), renderCopy()];
  const renderEllipsis = (needEllipsis) => [needEllipsis && React30.createElement("span", {
    "aria-hidden": true,
    key: "ellipsis"
  ...
  return React30.createElement(es_default, {
    ...
    title
  }, textProps), React30.createElement(Ellipsis_default, {
    ...
    if (node.length && needEllipsis && topAriaLabel) {
      renderNode = React30.createElement("span", {
        key: "show-content",
        "aria-hidden": true
      }, renderNode);
    }
    const wrappedContext = wrapperDecorations(props, React30.createElement(React30.Fragment, null, renderNode, renderEllipsis(needEllipsis)));
...
var Link = React31.forwardRef((_a, ref) => {
  var {
    ellipsis,
    rel
  ...
  return React31.createElement(Base_default, Object.assign({}, mergedProps, {
    ref,
    ellipsis: !!ellipsis,
    component: "a"
  }));
...
//# sourceMappingURL=chunk-DDVVIZSY.js.map
